    ...
    return (
            <View style={styles.containerHome}>
                ...
                <View style={styles.childSelect}>
                    <Select selectedValue={child} minWidth="200" accessibilityLabel="Select Child" placeholder="Select Child" _selectedItem={{bg: "teal.600"}} mt={1} onValueChange={itemValue => setChild(itemValue)}>
                    ...
                    <View style={[styles.verticalContainer]}>
                                ...
                                <View style={[styles.container2]}>
                                    ...
                                    {/* PLAY BUTTON */}
                                    <View style={[styles.playButton, t.flex, t.justifyCenter, {backgroundColor: 'orange'}]}>
                                        <Image
