...
const GameCard = ({
  ...
  return (
	<TouchableOpacity style={styles.container} onPress={() => navigation.push(name)}>
		...
		{/* Action Button: Information buton to teach the player how to play the game */}
			<View style={[t.flex1, t.flexRow, t.selfEnd, t.mT1, t.mR2]}>
				<TouchableOpacity onPress={() => navigation.push("InfoModal", {name: name, info: info})}>
					<Image
		...
		{/* PLAY BUTTON */}
		<View style={[styles.playButton, t.flex, t.justifyCenter, {backgroundColor: themeColor}]}>
			<Image
